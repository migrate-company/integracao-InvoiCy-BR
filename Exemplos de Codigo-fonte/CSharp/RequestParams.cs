namespace IntegracaoInvoicy.Models
{
    public class RequestParams
    {
        ...
        public RequestParams(string _cnpj, string _chaveDeAcesso, string _chaveDeParceiro, int _segundosExp)
        {
            cnpj = _cnpj;
            chaveDeAcesso = _chaveDeAcesso;
            chaveDeParceiro = _chaveDeParceiro;
            segundosExp = _segundosExp;
        }
    }
}
